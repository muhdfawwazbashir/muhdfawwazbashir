...
[![Twitter Badge](https://img.shields.io/badge/-@fawwaz_codes-1ca0f1?style=for-the-badge&logo=twitter&logoColor=white&link=https://twitter.com/fawwaz_codes)](https://twitter.com/fawwaz_codes)

---

### 👨🏾‍💻 About Me
I'm a **Backend Developer (Python/FastAPI)** and Geology graduate who loves solving problems with code and data. Currently studying at **AltSchool Africa (Backend Engineering Track)**, where I’m building skills in APIs, databases, and cloud integrations.  

Passionate about **software engineering, research, and sustainable technology**, I enjoy working on projects that improve productivity and well-being for people.  

---

### 🚀 Quick Summary
- 🌱 Currently learning: **FastAPI, Databases, Cloud Deployment**  
- 🛠️ Interested in: **Backend Dev, APIs, Data Management, Research-driven Tech**  
- 💼 Looking for: **Internships, open-source projects, and backend engineering opportunities**  
- ✍🏽 I also write, learn in public, and enjoy sharing knowledge.  
...
- Twitter: [@fawwaz](https://twitter.com/)  
